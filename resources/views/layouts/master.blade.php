...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/style.css?v=2.1.2.2">
...
<script>
  ...
  firebase.initializeApp(config);
    ...
    <script src="/js/master.js?v=2.1.2.0" ></script>
    ...
    @if($controller == "Customer")
        <script src="/js/custom/customer.js?v=2.1.2.3" ></script>
    ...
    @elseif($controller == "RegisterController")
        <script src="/js/custom/employee.js?v=2.1.2.0" ></script>
    @elseif($controller == "Clients")
        <script src="/js/client/clients.js?v=2.1.2.0" ></script>
    @elseif($controller == "Regions")
        <script src="/js/region/city.js?v=2.1.2.0" ></script>
    @elseif($controller == "Delivery")
        <script src="/js/delivery/delivery_team.js?v=2.1.2.0" ></script>
    @elseif($controller == "InventoryMenagement")
        <script src="/js/inventory/inventory_menagment.js?v=2.1.2.0" ></script>
    @elseif($controller == "ManageBilling")
        <script src="/js/billing/manage_billing.js?v=2.1.2.0" ></script>
    @elseif($controller == "ProductManegment")
        <script src="/js/product_manegment/product_manegment.js?v=2.1.2.0" ></script>
    @elseif($controller == "OrderManagement")
        <script src="/js/order_manegment/order.js?v=2.1.2.0" ></script>
    @endif
